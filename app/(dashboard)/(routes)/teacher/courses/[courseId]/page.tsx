...
import ChaptersFormForm from "./_components/chapters-form";
...
const CourseIdPage = async ({
  ...
  return (
    <>
      {!course.isPublished && (
        <Banner label="This course is unpublished. it will note be visible to the students." />
      )}
      <div className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-16">
          ...
          <div className="space-y-6">
            <div>
              ...
              <ChaptersFormForm initialData={course} courseId={courseId} />
            </div>
            <div>
              <div className="flex items-center gap-x-2">
